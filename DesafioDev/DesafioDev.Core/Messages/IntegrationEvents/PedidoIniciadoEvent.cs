...
namespace DesafioDev.Core.Messages.IntegrationEvents
{
    public class PedidoIniciadoEvent : BaseMessage
    {
        ...
        public PedidoIniciadoEvent(Guid pedidoId, Guid clienteId, decimal total, ListaProdutosPedido itens, string nomeCartao, string numeroCartao, string expiracaoCartao, string cvvCartao)
        {
            PedidoId = pedidoId;
            ClienteId = clienteId;
            Total = total;
