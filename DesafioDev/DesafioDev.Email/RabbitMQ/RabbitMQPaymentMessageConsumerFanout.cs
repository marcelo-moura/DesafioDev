...
{
    public class RabbitMQPaymentMessageConsumerFanout : BackgroundService
    {
        ...
        public RabbitMQPaymentMessageConsumerFanout(IServiceProvider service, IConfiguration configuration)
        {
            _service = service;
