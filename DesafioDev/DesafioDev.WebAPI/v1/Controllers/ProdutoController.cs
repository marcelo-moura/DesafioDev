...
namespace DesafioDev.WebAPI.v1.Controllers
{
    ...
    public class ProdutoController : BaseController
    {
        ...
        {
            var produtos = await _produtoService.FindPagedSearch<ProdutoViewModelSaida, FiltroProdutoViewModelEntrada, ResultadoConsultaProduto>
                (filtroProduto, page, pageSize, sortOrder, sortDirection, "sp_ListarProdutos");
            return CustomResponse(produtos);
        }
